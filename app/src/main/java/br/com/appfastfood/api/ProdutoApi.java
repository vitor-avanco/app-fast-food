...
import br.com.appfastfood.api.requests.ProdutoRequest;
...
public class ProdutoApi {
    ...
    public ResponseEntity<List<ProdutoPresenter>> obterProdutosPorCategoria(@PathVariable String categoria) {
        return ResponseEntity.ok(produtoController.obterProdutosPorCategoria(categoria.toUpperCase()));
    }
